<?php 
namespace laptrinhvienso0\ithandevvncheckoutforwoocommerce;
    ...
    class Ithadech_Vietnam_Shipping  {
        ...
        public function ithandech_get_list_district_select( $province_code ) {
            ...
            $result = array( '' => __( 'Chọn quận/huyện', 'ithan-devvn-checkout-for-woocommerce' ) ) + $result;
        ...
        public function ithandech_get_list_village_select( $district_code ) {
            ...
            $result = array( '' => __( 'Chọn xã/phường', 'ithan-devvn-checkout-for-woocommerce' ) ) + $result;
